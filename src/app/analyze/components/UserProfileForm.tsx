          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <button
                ...
                className={`p-4 text-sm font-medium border border-stone-300 rounded-lg cursor-pointer flex items-center gap-2 transition-colors ${
                  userProfile.category === option.value
                    ? "bg-stone-200"
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`p-3 text-sm font-medium border border-stone-300 rounded-lg cursor-pointer transition-colors ${
                        userProfile.bodyShape === option.value
                          ? "bg-stone-200"
                          : "bg-stone-50 hover:bg-stone-100"
                      }`}
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`p-3 text-sm font-medium border border-stone-300 rounded-lg cursor-pointer transition-colors ${
                        userProfile.footType === option.value
                          ? "bg-stone-200"
                          : "bg-stone-50 hover:bg-stone-100"
                      }`}
                    >
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`p-3 text-sm font-medium border border-stone-300 rounded-lg cursor-pointer transition-colors ${
                        userProfile.fitPreference === option.value
                          ? "bg-stone-200"
                          : "bg-stone-50 hover:bg-stone-100"
                      }`}
                    >
