...
export function ProductRecommendations({ 
  ...
  const { analysisResult, loading, error, getRecommendations, loadCachedResult } = useRecommendations();
  ...
  const handleRefresh = useCallback(async () => {
    ...
    const cacheKey = `recommendations_${userEmail || 'anonymous'}_${productName}_${brandName}`;
  ...
  }, [userEmail, productName, brandName, brandUrl, loadCachedResult, getRecommendations, llmQuery]);
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              {loading ? 'Getting personalized fit recommendations and reviews...' : 'Get personalized fit recommendations and reviews for this product'}
            </p>
            {loading && (
              <div className="flex items-center justify-center">
                ...
                <span className="text-blue-600 font-medium">Getting Recommendations...</span>
              </div>
            )}
          </div>
        </div>
